...
title.config(bg='#A7C5EB', fg='#2E2E2E')  
title.config(font=font)           
title.config(height=3, width=120)       
title.place(x=0,y=5)

font1 = ('times', 12, 'bold')
text=Text(main,height=20,width=150,bg='#F4F7F9', fg='black')
...
button_bg = '#A0E7E5'     # Soft pastel mint
button_fg = '#2C2C2C'     # Dark charcoal for readable text

# Button setup
uploadButton = Button(main, text="Upload NSL-KDD Dataset", command=uploadDataset, bg=button_bg, fg=button_fg)
uploadButton.place(x=50, y=550, width=250, height=40)
uploadButton.config(font=font1)

processButton = Button(main, text="Preprocess Dataset", command=preprocess, bg=button_bg, fg=button_fg)
processButton.place(x=320, y=550, width=250, height=40)
processButton.config(font=font1)

adasynButton1 = Button(main, text="ADASYN Augmentation", command=augmentation, bg=button_bg, fg=button_fg)
adasynButton1.place(x=590, y=550, width=250, height=40)
adasynButton1.config(font=font1)

splitButton = Button(main, text="Dataset Train & Test Split", command=trainTestSplit, bg=button_bg, fg=button_fg)
splitButton.place(x=860, y=550, width=250, height=40)
splitButton.config(font=font1)

spccnnButton = Button(main, text="Train SPC-CNN Algorithm", command=runSPCCNN, bg=button_bg, fg=button_fg)
spccnnButton.place(x=50, y=600, width=250, height=40)
spccnnButton.config(font=font1)

existingButton = Button(main, text="Run Naive Bayes Algorithms", command=runNaiveBayes, bg=button_bg, fg=button_fg)
existingButton.place(x=320, y=600, width=250, height=40)
existingButton.config(font=font1)

graphButton = Button(main, text="Run SVM Algorithm", command=runSVM, bg=button_bg, fg=button_fg)
graphButton.place(x=590, y=600, width=250, height=40)
graphButton.config(font=font1)

compareButton = Button(main, text="Comparison Graph", command=graph, bg=button_bg, fg=button_fg)
compareButton.place(x=860, y=600, width=250, height=40)
compareButton.config(font=font1)

predictButton = Button(main, text="Predict Attack from Test Data", command=predict, bg=button_bg, fg=button_fg)
predictButton.place(x=320, y=650, width=500, height=40)
predictButton.config(font=font1)

# Background for the main window
main.config(bg='#FFFDF4')  # Soft cream background
main.mainloop()
